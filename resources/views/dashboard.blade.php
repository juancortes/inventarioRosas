        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <h3 >Fecha y hora de corte: <?php echo date('Y-m-d H:i:s') ?></h3>
    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="row row-deck row-cards">
                ...
                <br>
                <br>
                <!-- se debe mostrar todas las fincas prametrizadas y cuantos
                    ramos han sido procesados para cada finca a la fecha y hora de hoy -->
                <h2 class="page-title">
                    Por Finca
                </h2>
                <div class="col-12">
                    <div class="row row-cards">
                      @foreach($fincaxRamo as $data)
                        <div class="col-sm-6 col-lg-3">
                            <div class="card card-sm">
                                <div class="card-body">
                                    <div class="row align-items-center">
